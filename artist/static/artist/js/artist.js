...
$('#headshot')
		.click(
				function() {
					...
					var headshotHeader = document
							.getElementById('headshot-header');
					var frameCanvas = document
							.getElementById('headshot-frame-canvas');
					var headshotCanvas = document
							.getElementById('headshot-photo-canvas');
					var frameImage = document.getElementById(
							'headshot-frame-img').cloneNode();
					var headshotImage = document.getElementById(
							'headshot-photo-img').cloneNode();
					...
					var newHeadshotHeight = (newHeadshotWidth / headshotWidth)
							* headshotHeight;
					...
					var newFrameWidth = newHeadshotWidth
							+ (newFrameLeftSize * 2);
					var newFrameHeight = newHeadshotHeight
							+ (newFrameTopSize * 2);
					...
					frameCanvas.getContext("2d").drawImage(frameImage, 0, 0,
							frameWidth, frameHeight, 0, 0, newFrameWidth,
							newFrameHeight);

					headshotCanvas.getContext("2d").drawImage(headshotImage, 0,
							0, headshotWidth, headshotHeight, newFrameLeftSize,
							newFrameTopSize, newHeadshotWidth,
							newHeadshotHeight);
